...
my_plot <- ggplot(data = mass, aes(x = type)) +
  geom_bar() +
  labs(x = "Type", y = "Number of Parks in MA") +
  theme_bw() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1, size = 7))

#Saving Plots
ggsave("MA Parks.png", my_plot, width = 15, height = 10)

#More plotting packages
...
ggsave("Acadia Visitation.png", acad_vis, width = 15, height = 10)
